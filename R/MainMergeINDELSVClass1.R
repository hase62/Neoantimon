#' Merge Results from MainINDELClass1.R or MainSVFUSIONClass1.R
#'
...
#'
#'@param annotation_file The result annotation file (${vcf}.${job_id}.peptide.txt) generated by MainINDELClass1() or MainSVFUSIONClass1(). 
...
#'
#'@export
MainMergeINDELSVClass1<-function(hmdir = getwd(), 
                             annotation_file, 
                             input_dir, 
                             file_prefix){
