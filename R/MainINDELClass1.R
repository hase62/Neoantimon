...
#'See by data(hla_table); hla_table;
#'
...
#'
#'@param refFlat_file refFlat file to be used in constructing peptide. (Default=paste(hmdir,"ib/refFlat.txt",sep="")
#'This file is automaticalluy generated by Main_Preparation.sh
#'
#'@param refMrna_1 refMrna file to be used in constructing peptide (Default=paste(hmdir,"ib/refMrna.merge.cut1.fa",sep="").
#'This file is automaticalluy generated by Main_Preparation.sh
#'
#'@param refMrna_3 refMrna file to be used in constructing peptide (Default=paste(hmdir,"ib/refMrna.merge.cut3.fa",sep="").
#'This file is automaticalluy generated by Main_Preparation.sh
#'
...
#'
#'@param netMHCpan_dir The file directory to netMHCpan (Default="ib/netMHCpan-3.0/netMHCpan").
#'
