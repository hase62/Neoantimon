#'Calculate Neoantigen Candidates on SVs at Exonic-Intron Region for MHC Class1
#'
#'@param input_file (Required) An input file (BND format) annotated by, e.g., ANNOVAR (http://annovar.openbioinformatics.org/en/latest/) or other softwares.
