...
#'
#'@export
MainSNVClass2<-function(input_annovar_format_file = NA,
                        ...
                        hmdir = getwd(),
                        job_id = "ID",
                        export_dir = paste("result", job_id, "SNV2", sep="."),
                        rnaexp_file = NA,
                        rnabam_file = NA,
                        cnv_file=NA,
                        purity = 1,
                        netMHCIIpan_dir = paste(hmdir, "lib/netMHCIIpan-3.2/netMHCIIpan", sep="/"),
