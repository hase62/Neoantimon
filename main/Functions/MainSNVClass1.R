MainNeoantigenidentificationClass1<-function(input_file, HLA_file, file_name_in_HLA_table = input_file,
  ...
  GenerateMutatedSeq(input_file = input_file, hmdir = hmdir, job_ID = job_ID,
                     ...
                     max_peptide_length = max_peptide_length, Chr_Column = Chr_Column, 
